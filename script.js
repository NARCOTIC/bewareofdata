...
var optionButtons = [document.querySelector("#quizOption1"), document.querySelector("#quizOption2"),document.querySelector("#quizOption3"), document.querySelector("#quizOption4")]
...
function showEndGame() {
    ...
    if (time != 0) {
        document.querySelector("#showScore").textContent = finalScore + (time / 10);
    } else {
        document.querySelector("#showScore").textContent = "INCOMPLETE";
    }
